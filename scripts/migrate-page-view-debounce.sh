...
# Adds last_page_view_at column to users table (idempotent).
# Run from the project root: ./scripts/migrate-page-view-debounce.sh
...
if (!columns.includes('last_page_view_at')) {
